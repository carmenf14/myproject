...
@WebServlet("/cursuriprofesor")
public class ListaCursuriProfesorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String str="SELECT * FROM public.\"cursuri\" WHERE id_profesor=?";
        try {
            PreparedStatement preparedStatement=conn.prepareStatement(str);
            preparedStatement.setLong(1,Long.valueOf(request.getParameter("id_profesor")));
            ...
            if(resultSet.isBeforeFirst()){
                ...
                jsonObject.put("lista_cursuri_profesor",jsonArray);
            }
