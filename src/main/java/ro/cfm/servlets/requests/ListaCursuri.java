 ...
 */
@WebServlet("/cursuri")
public class ListaCursuri extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String str="SELECT * FROM public.\"cursuri\" JOIN public.\"profesori\" ON cursuri.id_profesor = profesori.id";
        try {
            ...
            if(resultSet.isBeforeFirst()){
                while (resultSet.next()){
                    ...
                    aux.put("nume_prof", resultSet.getString("nume"));
                    aux.put("prenume_prof", resultSet.getString("prenume"));
                    jsonArray.put(aux);
                }
                jsonObject.put("lista_cursuri",jsonArray);
            }
